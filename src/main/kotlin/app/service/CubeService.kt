...
class CubeService : KoinComponent {
    ...
    fun setLine(cube : Cube, sideColor : Color, index : Int, newElements : Array<Color>) : Array<Color>
    {
        return sideService.setLine(getSideByColor(cube, sideColor), index, newElements)
    }

    fun getColumn(cube : Cube, sideColor: Color, index: Int) : Array<Color>
    {
        return sideService.getColumn(getSideByColor(cube, sideColor),index)
    }

    fun setColumn(cube : Cube, sideColor : Color, index : Int, newElements : Array<Color>) : Array<Color>
    {
        return sideService.setColumn(getSideByColor(cube, sideColor), index, newElements)
    }

    fun replaceLineOrColumn(cube : Cube, replaceType : String, reverse : Boolean, index : Int, sideColor : Color, newElements : Array<Color>) : Array<Color>
    {
