...
class ColorResolver {
    ...
    var orangeLab = Scalar(60.0 , 50.0 , 45.0)
    var redLab = Scalar(50.0 , 50.00 , 30.0 )
    var greenLab = Scalar(50.0, -55.0 , 40.0 )
    var blueLab = Scalar(50.0,-30.0,-30.0)
    var yellowLab = Scalar(60.0,-25.0, 40.0)
    var whiteLab = Scalar(70.0, 0.0, 0.0 )
    ...
    fun initFixContours()
    {
        var diffY = 0.0
        var diffX = - 40.0
        contoursFinaux.add(MatOfPoint(Point(162.0+diffX,11.0+diffY), Point(223.0+diffX,10.0+diffY), Point(224.0+diffX,67.0+diffY), Point(163.0+diffX,68.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(318.0+diffX,15.0+diffY), Point(371.0+diffX,14.0+diffY), Point(372.0+diffX,67.0+diffY), Point(319.0+diffX,68.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(444.0+diffX,25.0+diffY), Point(501.0+diffX,24.0+diffY), Point(502.0+diffX,79.0+diffY), Point(445.0+diffX,80.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(173.0+diffX,136.0+diffY), Point(232.0+diffX,137.0+diffY), Point(231.0+diffX,202.0+diffY), Point(172.0+diffX,201.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(302.0+diffX,141.0+diffY), Point(369.0+diffX,140.0+diffY), Point(370.0+diffX,207.0+diffY), Point(303.0+diffX,208.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(445.0+diffX,152.0+diffY), Point(508.0+diffX,153.0+diffY), Point(507.0+diffX,220.0+diffY), Point(444.0+diffX,219.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(163.0+diffX,270.0+diffY), Point(226.0+diffX,271.0+diffY), Point(225.0+diffX,342.0+diffY), Point(162.0+diffX,341.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(309.0+diffX,284.0+diffY), Point(370.0+diffX,285.0+diffY), Point(369.0+diffX,348.0+diffY), Point(308.0+diffX,347.0+diffY)))
        contoursFinaux.add(MatOfPoint(Point(448.0+diffX,293.0+diffY), Point(511.0+diffX,292.0+diffY), Point(512.0+diffX,355.0+diffY), Point(449.0+diffX,356.0+diffY)))
    }

    fun resolveColors(filename : String, takePicture : Boolean) : ArrayList<Color>
    {
        results.clear()
        contours.clear()
